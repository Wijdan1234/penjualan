<?php $this->load->view('element/head');?>
  ...
  <div class="content-wrapper" xmlns="http://www.w3.org/1999/html">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Transaksi Form</a></li>
      ...
      <div class="row">
        <div class="col-xs-12">
          <ul class="nav nav-tabs">
            <li role="presentation" class="active"><a href="<?php echo site_url('transaksi/create');?>">Input Transaksi</a></li>
            ...
            <?php } ?>
              <div class="box-body">
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    <label class="col-sm-4 control-label" for="category_id">Sales</label>
                    <div class="col-sm-8">
