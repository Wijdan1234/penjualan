      ...
      <div class="row">
        <div class="col-xs-12">
            <ul class="nav nav-tabs">
                <li role="presentation"><a href="<?php echo site_url('supplier/create');?>">Input Sales</a></li>
                <li role="presentation" class="active"><a href="<?php echo site_url('supplier');?>">List Sales</a></li>
            </ul>
          <div class="box">
              ...
              <form action="<?php echo site_url('supplier?search=true');?>" method="GET">
                ...
                <div class="box-body pad">
                  ...
                  <div class="col-md-3">
                    <div class="form-group">
                      <label for="submit">&nbsp</label>
                      <a href="<?php echo site_url('supplier/export_csv').get_uri();?>" class="form-control btn btn-default"><i class="fa fa-file-excel-o"></i> Export Excel</a>
                    </div>
                  </div>
                </div>
              </form>
