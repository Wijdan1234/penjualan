      ...
      <div class="row">
        <div class="col-xs-12">
          <ul class="nav nav-tabs">
            <li role="presentation" class="active"><a href="<?php echo site_url('supplier/create');?>">Input Sales</a></li>
            <li role="presentation"><a href="<?php echo site_url('supplier');?>">List Sales</a></li>
          </ul>
              ...
              <div class="box-body">
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <input type="text" value="<?php echo !empty($supplier) ? $supplier['supplier_name'] : '';?>" name="supplier_name" placeholder="Nama Sales" id="name" class="form-control" required/>
                    </div>
                  </div>
                  <div class="form-group">
